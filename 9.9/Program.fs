...
//Разработать программу, которая будет выводить первый элемент списка, делящейся на 5.

[<EntryPoint>]
let main argv =
     let form = new Form(Width=302, Height=250,Text = "Работа со списками.")
     let button1 = new Button(Left=21, Top=38, Text="Исходный список", Width=96,Height=46)
     let button2 = new Button(Left=21, Top=90, Text="Вычислить!", Width=96, Height=46)
