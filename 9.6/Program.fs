...
<Button Content='Привет, Супер-Прогер!' Height='75' HorizontalAlignment='Left' Margin='
12,10,0,0' Name='button9' VerticalAlignment='Top' Width='286' 
Grid.ColumnSpan='2' />
<Button Content='Все лабы по F#' Height='75' HorizontalAlignment='Left' Margin='
...
<Button Content='Самоэкзамен по ФИЛП!' Height='55' HorizontalAlignment='
...
//главная форма:
let button9 = win.FindName("button9") :?> Button  //на форму 1 
let button10 = win.FindName("button10") :?> Button //на форму 2
let button11 = win.FindName("button11") :?> Button //на форму 3
let button12 = win.FindName("button12") :?> Button //на форму 4-выход
//обработка событий
...
<Grid>
 ...
 <Button Content=' К переходу к самоэкзмену по ФИЛПУ!' Height='75' HorizontalAlignment='Left' Margin='
12,10,0,0' Name='button1' VerticalAlignment='Top' Width='286' 
Grid.ColumnSpan='2' />
    <Button Content='Выход' Height='23' HorizontalAlignment='Left' Margin='
12,153,0,0' Name='button2' VerticalAlignment='Top' Width='305'
...
<Grid>
 ...
 <Button Content=' К переходу ко всем лабам по F#!' Height='75' HorizontalAlignment='Left' Margin='
12,10,0,0' Name='button1' VerticalAlignment='Top' Width='286' 
Grid.ColumnSpan='2' />
    <Button Content='Выход' Height='23' HorizontalAlignment='Left' Margin='
12,153,0,0' Name='button2' VerticalAlignment='Top' Width='305'
