...
let main argv =
    ...
    Console.WriteLine("Произведение чётных делителей числа:{0}",obxod a (fun x -> x%2=0) (fun x y ->x*y) 1)
    Console.WriteLine("Сумма нечётных чисел, взаимно простых с данным:{0}", obrabotka a (fun x->x%2=1) (fun x y->x+y) 0 )
    0